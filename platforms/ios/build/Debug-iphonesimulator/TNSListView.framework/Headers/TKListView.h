 ...
 */
- (void) willInsertItemsAtIndexPaths:(NSArray * __nonnull) indexPaths;
...
- (void) didEndDisplayingAtIndexPaths:(NSIndexPath * __nonnull) indexPaths cell:(UICollectionViewCell * __nonnull) cell;
...
/**
 Notifies the list view that new data requested on demand is ready to be shown.
 */
- (void)didLoadDataOnDemand;

/**
Notifies the list view that a new data requested on demand is ready to be shown.
Optimized version of the previous method which is to be used when the only change
is that some number of items have been appended at the end of the list.
@param addedItemsCount the number of items which have been appended.
*/
- (void)didAppendItemsOnDemand:(NSUInteger)addedItemsCount;
